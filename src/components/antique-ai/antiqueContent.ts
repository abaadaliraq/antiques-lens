...
export const content = {
  ar: {
    ...
    cancellingAnalysis: "جاري الإلغاء...",
    analysisCancelled: "تم إلغاء التحليل.",
    metalPrices: "أسعار المعادن",
    uploadingImages: "جارٍ رفع الصور...",
    analyzingItem: "جارٍ تحليل القطعة...",
    searchingSimilar: "جارٍ البحث عن صور مشابهة...",
  ...
  en: {
    ...
    analyzingItem: "Analyzing the item...",
    searchingSimilar: "Searching for similar images...",
    preparingResult: "Preparing the result...",
  ...
  fr: {
    ...
    cancellingAnalysis: "Annulation...",
    analysisCancelled: "Analyse annulée.",
    metalPrices: "Prix des métaux",
    uploadingImages: "Téléversement des images...",
    analyzingItem: "Analyse de l’objet...",
    searchingSimilar: "Recherche d’images similaires...",
  ...
  hi: {
    ...
    cancellingAnalysis: "रद्द हो रहा है...",
    analysisCancelled: "विश्लेषण रद्द किया गया.",
    metalPrices: "धातु मूल्य",
    uploadingImages: "तस्वीरें अपलोड हो रही हैं...",
    analyzingItem: "वस्तु का विश्लेषण हो रहा है...",
    searchingSimilar: "मिलती-जुलती तस्वीरें खोजी जा रही हैं...",
    preparingResult: "परिणाम तैयार किया जा रहा है...",
  ...
  fa: {
    ...
    cancellingAnalysis: "در حال لغو...",
    analysisCancelled: "تحلیل لغو شد.",
    metalPrices: "قیمت فلزات",
    uploadingImages: "در حال بارگذاری تصاویر...",
    analyzingItem: "در حال تحلیل قطعه...",
    searchingSimilar: "در حال جستجوی تصاویر مشابه...",
    preparingResult: "در حال آماده‌سازی نتیجه...",
    analysisInProgress: "تحلیل در حال انجام است...",
  ...
  tr: {
    ...
    analysisCancelled: "Analiz iptal edildi.",
    metalPrices: "Metal fiyatları",
    uploadingImages: "Görseller yükleniyor...",
    analyzingItem: "Parça analiz ediliyor...",
    searchingSimilar: "Benzer görseller aranıyor...",
  ...
  ku: {
    ...
    send: "شیکردنەوە",
    analyzing: "شیکردنەوە...",
    cancelAnalysis: "هەڵوەشاندنەوەی شیکردنەوە",
    cancellingAnalysis: "هەڵدەوەشێتەوە...",
    analysisCancelled: "شیکردنەوە هەڵوەشایەوە.",
    metalPrices: "نرخی کانزاکان",
    uploadingImages: "وێنەکان بار دەکرێن...",
    analyzingItem: "پارچەکە شیکرایەوە...",
    searchingSimilar: "بەدوای وێنەی هاوشێوەدا دەگەڕێت...",
    preparingResult: "ئەنجامەکە ئامادە دەکرێت...",
    analysisInProgress: "شیکردنەوە بەردەوامە...",
  ...
  es: {
    ...
    archive: "Archivo de piezas",
    emptyArchive: "Todavía no hay evaluaciones.",
    clearArchive: "Borrar",
    openArchive: "Archivo",
    badge: "KISHIB",
    sub: "Evaluador de antigüedades y objetos patrimoniales",
    title: "Evalúa cualquier antigüedad u objeto patrimonial",
    hint: "Sube o toma una imagen clara y estimaremos la época, el material, el estado, el valor y referencias similares.",
    placeholder: "Añade cualquier dato que conozcas sobre la pieza...",
    upload: "Subir imagen",
    camera: "Cámara",
    send: "Analizar",
    analyzing: "Analizando...",
    cancelAnalysis: "Cancelar análisis",
    cancellingAnalysis: "Cancelando...",
    analysisCancelled: "Análisis cancelado.",
    metalPrices: "Precios de metales",
    uploadingImages: "Subiendo imágenes...",
    analyzingItem: "Analizando la pieza...",
    searchingSimilar: "Buscando imágenes similares...",
    preparingResult: "Preparando el resultado...",
    analysisInProgress: "Análisis en curso...",
    emptyError: "Añade una descripción o sube primero una imagen de la pieza.",
    imageReady: "Imagen adjunta",
    footer: "Para mayor precisión: imagen completa + marca o firma si existe.",
    ...
    description: "Descripción y análisis",
    condition: "Estado visible",
    authenticity: "Indicadores de autenticidad",
    safeInitialChecks: "Comprobaciones iniciales seguras",
    safeInitialChecksNote: "Estas comprobaciones no prueban la autenticidad de forma definitiva, pero ayudan a reunir información más clara antes de una revisión experta.",
    carePreservation: "Cuidado y conservación",
    carePreservationNote: "Estos consejos ayudan a reducir daños, pero no sustituyen la atención de un especialista en piezas delicadas o de alto valor.",
    priceReason: "Razón del precio",
    valueDrivers: "¿Qué aumenta el valor?",
    valueReducers: "¿Qué reduce el valor?",
    similar: "Piezas similares",
    similarHint: "Aquí aparecerán imágenes, precios y enlaces reales cuando haya fuentes similares disponibles.",
    soon: "Pronto",
    neededPhotos: "Fotos necesarias para una evaluación más precisa",
    followUp: "Siguiente pregunta",
    confidence: "Nivel de confianza",
    share: "Compartir",
    addInfo: "Añadir información",
    notice: "Esta es una evaluación orientativa; no es un certificado de autenticidad ni una tasación definitiva.",
  },
} as const;
