...
const COPY: Record<Locale, AuthCopy> = {
  en: {
    eyebrow: "Authenticate • Evaluate • Preserve", intro: ["Photograph any piece and let KISHIB evaluate it.", "Know the value of your antiques and collectibles.", "Keep your evaluations, notes, and corrections in one account."], subtitle: "AI-assisted antique evaluation for collectors, dealers, and heritage lovers.", login: "Log in", signup: "Create account", name: "Full name", email: "Email", password: "Password", phone: "Phone number", gender: "Gender", male: "Male", female: "Female", country: "Country", province: "Province / City", birthDate: "Birth date", forgot: "Forgot password?", continue: "Continue", google: "Continue with Google", back: "Back", or: "or", legal: "By continuing, you agree to", terms: "Terms", privacy: "Privacy", cookies: "Cookies", checkEmail: "Account created. A confirmation link has been sent to your email.", configError: "Supabase setup is incomplete. Add the anon key to the environment file.", resetTitle: "Reset password", resetInstruction: "Enter your email and we will send a password reset link.", resetSubmit: "Send reset link", resetSuccess: "A password reset link has been sent to your email if the account exists.",
  },
  ar: {
    eyebrow: "وثّق • قيّم • احفظ", intro: ["صوّر أي قطعة وسيتم تقييمها.", "اعرف قيمة مقتنياتك بثقة أكبر.", "احفظ تقييماتك وملاحظاتك وتصحيحاتك في حساب واحد."], subtitle: "منصة ذكية لتقييم التحف والقطع التراثية لهواة الجمع والتجار.", login: "تسجيل الدخول", signup: "إنشاء حساب", name: "الاسم الكامل", email: "البريد الإلكتروني", password: "كلمة المرور", phone: "رقم الهاتف", gender: "الجنس", male: "ذكر", female: "أنثى", country: "الدولة", province: "المحافظة / المدينة", birthDate: "تاريخ الميلاد", forgot: "نسيت كلمة المرور؟", continue: "متابعة", google: "المتابعة بحساب Google", back: "رجوع", or: "أو", legal: "بالمتابعة أنت توافق على", terms: "الشروط", privacy: "الخصوصية", cookies: "الكوكيز", checkEmail: "تم إنشاء الحساب. سيصلك رابط التأكيد على بريدك الإلكتروني.", configError: "إعدادات Supabase غير مكتملة. أضف anon key في ملف البيئة.", resetTitle: "استعادة كلمة المرور", resetInstruction: "اكتب بريدك الإلكتروني وسنرسل لك رابط إعادة تعيين كلمة المرور.", resetSubmit: "إرسال رابط الاستعادة", resetSuccess: "تم إرسال رابط إعادة تعيين كلمة المرور إلى بريدك الإلكتروني إن كان الحساب موجودًا.",
  },
  fr: {
    eyebrow: "Authentifier • Évaluer • Préserver", intro: ["Photographiez une pièce et KISHIB l’évalue.", "Découvrez la valeur de vos antiquités et objets de collection.", "Gardez vos évaluations, notes et corrections dans un seul compte."], subtitle: "Évaluation d’antiquités assistée par IA pour collectionneurs, marchands et passionnés du patrimoine.", login: "Connexion", signup: "Créer un compte", name: "Nom complet", email: "E-mail", password: "Mot de passe", phone: "Téléphone", gender: "Genre", male: "Homme", female: "Femme", country: "Pays", province: "Province / Ville", birthDate: "Date de naissance", forgot: "Mot de passe oublié ?", continue: "Continuer", google: "Continuer avec Google", back: "Retour", or: "ou", legal: "En continuant, vous acceptez", terms: "Conditions", privacy: "Confidentialité", cookies: "Cookies", checkEmail: "Compte créé. Un lien de confirmation a été envoyé à votre e-mail.", configError: "La configuration Supabase est incomplète. Ajoutez la clé anon au fichier d’environnement.", resetTitle: "Réinitialiser le mot de passe", resetInstruction: "Saisissez votre e-mail et nous enverrons un lien de réinitialisation.", resetSubmit: "Envoyer le lien", resetSuccess: "Un lien de réinitialisation a été envoyé si le compte existe.",
  },
  hi: {
    eyebrow: "प्रमाणित करें • मूल्यांकन करें • सुरक्षित रखें", intro: ["किसी भी वस्तु की तस्वीर लें और KISHIB उसका मूल्यांकन करेगा.", "अपनी प्राचीन वस्तुओं और संग्रहणीय चीज़ों का मूल्य जानें.", "अपने मूल्यांकन, नोट्स और सुधार एक ही खाते में रखें."], subtitle: "संग्रहकर्ताओं, व्यापारियों और विरासत प्रेमियों के लिए AI-सहायित प्राचीन वस्तु मूल्यांकन.", login: "लॉग इन", signup: "खाता बनाएँ", name: "पूरा नाम", email: "ईमेल", password: "पासवर्ड", phone: "फ़ोन नंबर", gender: "लिंग", male: "पुरुष", female: "महिला", country: "देश", province: "प्रांत / शहर", birthDate: "जन्म तिथि", forgot: "पासवर्ड भूल गए?", continue: "जारी रखें", google: "Google से जारी रखें", back: "वापस", or: "या", legal: "जारी रखकर आप सहमत हैं", terms: "शर्तें", privacy: "गोपनीयता", cookies: "कुकीज़", checkEmail: "खाता बन गया. पुष्टि लिंक आपके ईमेल पर भेजा गया है.", configError: "Supabase सेटअप अधूरा है. पर्यावरण फ़ाइल में anon key जोड़ें.", resetTitle: "पासवर्ड रीसेट करें", resetInstruction: "अपना ईमेल दर्ज करें और हम रीसेट लिंक भेजेंगे.", resetSubmit: "रीसेट लिंक भेजें", resetSuccess: "यदि खाता मौजूद है तो रीसेट लिंक आपके ईमेल पर भेजा गया है.",
  },
  fa: {
    eyebrow: "احراز هویت • ارزیابی • نگهداری", intro: ["از هر قطعه عکس بگیرید تا KISHIB آن را ارزیابی کند.", "ارزش اشیای عتیقه و کلکسیونی خود را بدانید.", "ارزیابی‌ها، یادداشت‌ها و اصلاحات خود را در یک حساب نگه دارید."], subtitle: "ارزیابی عتیقه با کمک هوش مصنوعی برای مجموعه‌داران، فروشندگان و دوستداران میراث.", login: "ورود", signup: "ایجاد حساب", name: "نام کامل", email: "ایمیل", password: "رمز عبور", phone: "شماره تلفن", gender: "جنسیت", male: "مرد", female: "زن", country: "کشور", province: "استان / شهر", birthDate: "تاریخ تولد", forgot: "رمز عبور را فراموش کرده‌اید؟", continue: "ادامه", google: "ادامه با Google", back: "بازگشت", or: "یا", legal: "با ادامه، شما موافقت می‌کنید با", terms: "شرایط", privacy: "حریم خصوصی", cookies: "کوکی‌ها", checkEmail: "حساب ایجاد شد. لینک تأیید به ایمیل شما ارسال شد.", configError: "تنظیمات Supabase کامل نیست. کلید anon را به فایل محیط اضافه کنید.", resetTitle: "بازنشانی رمز عبور", resetInstruction: "ایمیل خود را وارد کنید تا لینک بازنشانی ارسال شود.", resetSubmit: "ارسال لینک بازنشانی", resetSuccess: "اگر حساب وجود داشته باشد، لینک بازنشانی به ایمیل شما ارسال شده است.",
  },
  tr: {
    eyebrow: "Doğrula • Değerlendir • Koru", intro: ["Herhangi bir parçayı fotoğraflayın, KISHIB değerlendirsin.", "Antika ve koleksiyon parçalarınızın değerini öğrenin.", "Değerlendirmelerinizi, notlarınızı ve düzeltmelerinizi tek hesapta saklayın."], subtitle: "Koleksiyonerler, satıcılar ve miras tutkunları için AI destekli antika değerlendirme.", login: "Giriş yap", signup: "Hesap oluştur", name: "Ad soyad", email: "E-posta", password: "Şifre", phone: "Telefon numarası", gender: "Cinsiyet", male: "Erkek", female: "Kadın", country: "Ülke", province: "İl / Şehir", birthDate: "Doğum tarihi", forgot: "Şifrenizi mi unuttunuz?", continue: "Devam", google: "Google ile devam et", back: "Geri", or: "veya", legal: "Devam ederek şunları kabul edersiniz", terms: "Şartlar", privacy: "Gizlilik", cookies: "Çerezler", checkEmail: "Hesap oluşturuldu. Onay bağlantısı e-postanıza gönderildi.", configError: "Supabase kurulumu eksik. Ortam dosyasına anon key ekleyin.", resetTitle: "Şifreyi sıfırla", resetInstruction: "E-postanızı girin, şifre sıfırlama bağlantısı gönderelim.", resetSubmit: "Sıfırlama bağlantısı gönder", resetSuccess: "Hesap varsa sıfırlama bağlantısı e-postanıza gönderildi.",
  },
  ru: {
    eyebrow: "Подтвердить • Оценить • Сохранить", intro: ["Сфотографируйте предмет, и KISHIB оценит его.", "Узнайте стоимость антиквариата и коллекционных предметов.", "Храните оценки, заметки и исправления в одном аккаунте."], subtitle: "AI-оценка антиквариата для коллекционеров, дилеров и любителей наследия.", login: "Войти", signup: "Создать аккаунт", name: "Полное имя", email: "Email", password: "Пароль", phone: "Телефон", gender: "Пол", male: "Мужской", female: "Женский", country: "Страна", province: "Регион / город", birthDate: "Дата рождения", forgot: "Забыли пароль?", continue: "Продолжить", google: "Продолжить с Google", back: "Назад", or: "или", legal: "Продолжая, вы соглашаетесь с", terms: "Условиями", privacy: "Конфиденциальностью", cookies: "Cookies", checkEmail: "Аккаунт создан. Ссылка подтверждения отправлена на ваш email.", configError: "Настройка Supabase неполная. Добавьте anon key в файл окружения.", resetTitle: "Сброс пароля", resetInstruction: "Введите email, и мы отправим ссылку для сброса пароля.", resetSubmit: "Отправить ссылку", resetSuccess: "Если аккаунт существует, ссылка для сброса отправлена на email.",
  },
  ku: {
    eyebrow: "پشتڕاستکردنەوە • هەڵسەنگاندن • پاراستن", intro: ["وێنەی هەر پارچەیەک بگرە و KISHIB هەڵیدەسەنگێنێت.", "نرخی پارچە کۆن و کۆکردنەوەکانت بزانە.", "هەڵسەنگاندن، تێبینی و چاکسازییەکانت لە هەژمارێکدا بهێڵەوە."], subtitle: "هەڵسەنگاندنی پارچە کۆن بە یارمەتی AI بۆ کۆکەرەوە، بازرگان و خۆشەویستانی کەلەپوور.", login: "چوونەژوورەوە", signup: "دروستکردنی هەژمار", name: "ناوی تەواو", email: "ئیمەیل", password: "وشەی نهێنی", phone: "ژمارەی تەلەفۆن", gender: "ڕەگەز", male: "نێر", female: "مێ", country: "وڵات", province: "پارێزگا / شار", birthDate: "ڕێکەوتی لەدایکبوون", forgot: "وشەی نهێنیت لەبیرکردووە؟", continue: "بەردەوامبوون", google: "بە Google بەردەوامبە", back: "گەڕانەوە", or: "یان", legal: "بە بەردەوامبوون ڕازیت بە", terms: "مەرجەکان", privacy: "تایبەتمەندی", cookies: "کوکیز", checkEmail: "هەژمار دروستکرا. لینکی پشتڕاستکردنەوە بۆ ئیمەیلەکەت نێردرا.", configError: "ڕێکخستنی Supabase تەواو نییە. anon key زیاد بکە بۆ فایلی ژینگە.", resetTitle: "گۆڕینی وشەی نهێنی", resetInstruction: "ئیمەیلەکەت بنووسە تا لینکی گۆڕینی وشەی نهێنی بنێرین.", resetSubmit: "ناردنی لینک", resetSuccess: "ئەگەر هەژمارەکە هەبێت، لینکی گۆڕینی وشەی نهێنی نێردرا.",
  },
  es: {
    eyebrow: "Autenticar • Evaluar • Conservar", intro: ["Fotografía cualquier pieza y deja que KISHIB la evalúe.", "Conoce el valor de tus antigüedades y objetos de colección.", "Guarda tus evaluaciones, notas y correcciones en una sola cuenta."], subtitle: "Evaluación de antigüedades asistida por IA para coleccionistas, comerciantes y amantes del patrimonio.", login: "Iniciar sesión", signup: "Crear cuenta", name: "Nombre completo", email: "Correo electrónico", password: "Contraseña", phone: "Teléfono", gender: "Género", male: "Masculino", female: "Femenino", country: "País", province: "Provincia / ciudad", birthDate: "Fecha de nacimiento", forgot: "¿Olvidaste la contraseña?", continue: "Continuar", google: "Continuar con Google", back: "Volver", or: "o", legal: "Al continuar, aceptas", terms: "Términos", privacy: "Privacidad", cookies: "Cookies", checkEmail: "Cuenta creada. Se envió un enlace de confirmación a tu correo.", configError: "La configuración de Supabase está incompleta. Añade la anon key al archivo de entorno.", resetTitle: "Restablecer contraseña", resetInstruction: "Introduce tu correo y enviaremos un enlace para restablecer la contraseña.", resetSubmit: "Enviar enlace", resetSuccess: "Si la cuenta existe, se envió un enlace de restablecimiento a tu correo.",
  },
};
