...
export const marketplaceLocations: MarketplaceCountryOption[] = [
  ...
  },
  {
    ...
    value: "Canada",
    flag: "🇨🇦",
    labels: labels("Canada", "كندا", "Canada", "Canada", "Kanada", "Canada", "Canada", "Canada"),
    cities: [city("Montreal", "مونتريال"), city("Toronto", "تورونتو"), city("Vancouver", "فانكوفر")],
  },
  {
    code: "IT",
    value: "Italy",
    flag: "🇮🇹",
    labels: labels("Italy", "إيطاليا", "Italy", "Italy", "Italya", "Italy", "Italy", "Italie"),
    cities: [city("Florence", "فلورنسا"), city("Milan", "ميلانو"), city("Rome", "روما"), city("Venice", "البندقية")],
  },
  {
    code: "ES",
    value: "Spain",
    flag: "🇪🇸",
    labels: labels("Spain", "إسبانيا", "Spain", "Spain", "Ispanya", "Spain", "Spain", "Espagne"),
    cities: [city("Barcelona", "برشلونة"), city("Madrid", "مدريد"), city("Seville", "إشبيلية"), city("Valencia", "فالنسيا")],
  },
  {
    code: "AU",
    value: "Australia",
    flag: "🇦🇺",
    labels: labels("Australia", "أستراليا", "Australia", "Australia", "Avustralya", "Australia", "Australia", "Australie"),
    cities: [city("Melbourne", "ملبورن"), city("Perth", "بيرث"), city("Sydney", "سيدني")],
  },
  {
    code: "CN",
    value: "China",
    flag: "🇨🇳",
    labels: labels("China", "الصين", "China", "China", "Çin", "China", "China", "Chine"),
    cities: [city("Beijing", "بكين"), city("Guangzhou", "غوانزو"), city("Shanghai", "شنغهاي"), city("Xi'an", "شيان")],
  },
  {
    code: "JP",
    value: "Japan",
    flag: "🇯🇵",
    labels: labels("Japan", "اليابان", "Japan", "Japan", "Japonya", "Japan", "Japan", "Japon"),
